...
async def get_transcript(transcript_id: str, current_user: User = Depends(get_current_user)):
    try:
...
async def regenerate_summary(transcript_id: str, current_user: User = Depends(get_current_user)):
